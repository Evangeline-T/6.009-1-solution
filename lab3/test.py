...
def test_acted_together_04():
    # My test case, different actors not in same film
    actor1 = 1303433
    actor2 = 146295
    assert not lab.acted_together(db_small, actor1, actor2)
...
def test_bacon_number_05():
    # Tiny pickle graph, Bacon number of 0
    n = 0
    expected = {4724}
    tinydb = [(2876, 4724, 617),
 (4724, 1532, 31932),
 (1532, 1532, 31932),
 (1532, 4724, 617),
 (1532, 2876, 31932),
 (2876, 1640, 617),
 (1640, 1640, 74881)]
    first_result = lab.actors_with_bacon_number(lab.transform_data(tinydb), n)
    assert isinstance(first_result, set)
    assert first_result == expected
    
def test_bacon_number_06():
    # Tiny pickle graph, Bacon number of 1
    n = 1
    expected = {1532, 2876}
    tinydb = [(2876, 4724, 617),
 (4724, 1532, 31932),
...
def test_bacon_number_07():
    # Tiny pickle graph, Bacon number of 2
    n = 2
    expected = {1640}
    tinydb = [(2876, 4724, 617),
 (4724, 1532, 31932),
...
def test_bacon_number_08():
    # Tiny pickle graph, Bacon number of 3
    n = 3
    expected = set()
    tinydb = [(2876, 4724, 617),
 (4724, 1532, 31932),
...
def test_bacon_path():
    # Bacon path, tiny database, length of 3
    actor_id = 1640
    expected = 3
...
def test_actor_to_actor_path_09():
    # actor path that does exist
    data = raw_db_tiny[:]
    expected = [1640, 2876, 1532]
    result = lab.actor_to_actor_path(lab.transform_data(data), 1640, 1532)
